...
typedef IceCandidateEvent = ({String peerId, RTCIceCandidate candidate});
...
class WebRtcMeshClient {
  ...
  Future<RTCSessionDescription> createAnswer(String peerId, RTCSessionDescription offer) async {
    final pc = await _getOrCreateConnection(peerId);
