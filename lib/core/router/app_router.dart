...
import 'package:reader/features/scanner/presentation/scans_screen.dart';
import 'package:reader/features/settings/application/connection_notifier.dart';
import 'package:reader/features/settings/presentation/pages/profile_screen.dart';
import 'package:reader/features/settings/presentation/pages/settings_screen.dart';
...
final appRouter = GoRouter(
  ...
  redirect: (context, state) {
    ...
    if (isConnected && isAuthenticated && location == '/auth') return '/scanner';
    return null;
  },
  routes: [
    GoRoute(
