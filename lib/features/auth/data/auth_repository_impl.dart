...
import 'package:racs_reader/features/auth/data/reader_dto.dart';
import 'package:racs_reader/features/auth/domain/auth_repository.dart';
...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<Reader> getAuthReader() async {
    ...
    return ReaderDto.fromJson(
      json['reader'] as Map<String, dynamic>,
    ).toDomain();
  }
