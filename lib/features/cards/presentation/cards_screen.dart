...
import 'package:racs_reader/common/widgets/list_divider.dart';
import 'package:racs_reader/common/widgets/pagination_controls.dart';
...
class _TypeChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final (label, color) = switch (type) {
      ...
      card_domain.CardType.card => ('Card', Colors.blue),
